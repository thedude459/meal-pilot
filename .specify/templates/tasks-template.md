...
- [ ] T007 Create base models/entities that all stories depend on
  (align with constitution: FamilyMember, PreferenceProfile, Recipe,
  Ingredient, GroceryItem, PantryItem, WeeklyPlan as applicable)
- [ ] T008 Define Speckit specs for workflows/services in scope
  (`GenerateWeeklyMeals`, `BuildGroceryList`, `UpdatePantry`, and/or
...
- [ ] T015 [US1] Implement [Service] in src/services/[service].py (depends on T013, T014;
  keep business logic inside Speckit-defined services/workflows)
